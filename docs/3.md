...
**Identity Law** : A + 0 = A dan A ⋅ 1 = A. Hukum ini menyatakan bahwa 0 adalah elemen netral pada operasi OR, dan 1 adalah elemen netral pada operasi AND.
**Null Law** : A + 1 = 1 dan A ⋅ 0 = 0. Hukum ini menunjukkan bahwa 1 mendominasi operasi OR (hasilnya selalu 1) dan 0 mendominasi operasi AND (hasilnya selalu 0), tanpa memandang nilai variabel lainnya.
**Idempotent Law** : A + A = A dan A ⋅ A = A. Menggabungkan variabel dengan dirinya sendiri menggunakan OR maupun AND tidak mengubah nilainya.
**Inverse Law** : A + A′ = 1 dan A ⋅ A′ = 0. Sebuah variabel jika di-OR-kan dengan kebalikannya selalu menghasilkan 1, dan jika di-AND-kan dengan kebalikannya selalu menghasilkan 0.
**Commutative Law** : A + B = B + A dan A ⋅ B = B ⋅ A. Urutan variabel pada operasi OR dan AND dapat ditukar tanpa mengubah hasil akhir.
